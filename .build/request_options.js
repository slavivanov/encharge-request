...
exports.setRequestBody = function (options) {
    var json = _.cloneDeep(options.json);
    var form = _.cloneDeep(options.form);
    var body = _.cloneDeep(options.body);
    delete options.body;
    delete options.json;
    delete options.form;
    if (!options.headers) {
    ...
    var contentType = idx_1.default(options, function (_) { return _.headers["content-type"]; });
...
exports.parseQueryParams = function (_url, _options) {
